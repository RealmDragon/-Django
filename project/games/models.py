...
class Game(models.Model):
    ...
    type = models.ForeignKey(on_delete=models.SET_NULL, verbose_name='Жанр Игры', help_text='Введите Жанр Игры', null=True, blank=True, related_name='games_media')
    ...
    view_counter = models.PositiveIntegerField(default=0, verbose_name='Счетик просмотров', help_text='Просмотры')
